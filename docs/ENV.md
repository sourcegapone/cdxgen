...
| JAVA11_TOOL                  | Specifies the Java 11 toolchain version to use. Defaults to `11.0.29-tem` if not explicitly set. Can be overridden to point to a custom Java 11 version.                                                                                                                 |
| JAVA17_TOOL                  | Specifies the Java 17 toolchain version to use. Defaults to `17.0.17-tem` if not explicitly set. Can be overridden to point to a custom Java 17 version.                                                                                                                 |
| JAVA21_TOOL                  | Specifies the Java 21 toolchain version to use. Defaults to `21.0.9-tem` if not explicitly set. Can be overridden to point to a custom Java 21 version.                                                                                                                  |
