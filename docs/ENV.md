...
| JAVA11_TOOL                      | Specifies the Java 11 toolchain version to use. Defaults to `11.0.30-tem` if not explicitly set. Can be overridden to point to a custom Java 11 version.                                                                                                                 |
| JAVA17_TOOL                      | Specifies the Java 17 toolchain version to use. Defaults to `17.0.18-tem` if not explicitly set. Can be overridden to point to a custom Java 17 version.                                                                                                                 |
| JAVA21_TOOL                      | Specifies the Java 21 toolchain version to use. Defaults to `21.0.10-tem` if not explicitly set. Can be overridden to point to a custom Java 21 version.                                                                                                                 |
...
| JAVA25_TOOL                      | Specifies the Java 25 toolchain version to use. Defaults to `25.0.2-tem` if not explicitly set. Can be overridden to point to a custom Java 25 version.                                                                                                                  |
| JAVA26_TOOL                      | Specifies the Java 26 toolchain version to use. Defaults to `26-tem` if not explicitly set. Can be overridden to point to a custom Java 26 version.                                                                                                                      |
