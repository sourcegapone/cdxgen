...
function addComponent(
  ...
  if (!isRootPkg) {
    ...
    // Suppress generated purls both when the ambient project type is crypto and
    // when an individual package overrides its component type to cryptographic-asset.
    if (ptype === "cryptographic-asset" || pkg.type === "cryptographic-asset") {
      purl = undefined;
